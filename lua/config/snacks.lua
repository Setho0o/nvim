return {
	...
	opts = {
		...
		dashboard = {
			preset = {
				header = [[       ._-_.    ________________________
        +|\S/|+  | ______________________ |
        +|\./|+  || O  o * o  =|=  |   * ||
        +|\./|+  || O  * o *   |  =|=  | ||
         `|H|'   ||______*_____*___|___*_||
  ...
  \       ___ /  o  /M/MMMMMRMMMRMM88MM<<||
   \     |SSS|    l/MMMMMMMRMMMRMM88MM<<<||
    `-_   \_/   _-||RMMMMMRMMMRMM88MM<<<|||
       """"""""" ||||~~-~~~~~-~~~-~~~~~||||
]],
				keys = {
					{ icon = " ", key = "q", desc = "quit", action = ":q" },
					{ icon = " ", key = "p", desc = "search local", action = ":lua Snacks.dashboard.pick('files')" },
			...
			sections = {
				{ icon = " ", title = "Keymaps", section = "keys", indent = 2, padding = 4 },
